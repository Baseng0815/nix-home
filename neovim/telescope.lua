...
vim.keymap.set('n', '<C-t>j', builtin.diagnostics, {})
vim.keymap.set('n', '<C-t>s', builtin.symbols, {})
vim.keymap.set('n', '<C-t>m', builtin.marks, {})
vim.keymap.set('n', 'gj', ':cnext<CR>', { silent = true })
vim.keymap.set('n', 'gk', ':cprev<CR>', { silent = true })
