...
map("", "<C-w>l", ":set splitright<CR>:vsp<SPACE>", false)
map("", "<C-w>h", ":set nosplitright<CR>:vsp<SPACE>", false)
map("", "<C-w>k", ":set nosplitbelow<CR>:sp<SPACE>", false)
map("", "<C-w>j", ":set splitbelow<CR>:sp<SPACE>", false)
